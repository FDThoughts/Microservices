namespace eShop.EventsModule.EventBus.V1
{
        ...
        IEventBusSubscriptionsManager
    {
        ...
        public void RemoveDynamicSubscription<TH>(string eventName)
            where TH : IDynamicIntegrationEventHandler
        {
            var handlerToRemove = FindDynamicSubscriptionToRemove<TH>(
                eventName);
        ...
        public IEnumerable<SubscriptionInfo> GetHandlersForEvent(
            string eventName) => _handlers[eventName];
        ...
        private SubscriptionInfo FindDynamicSubscriptionToRemove<TH>(
            string eventName)
            where TH : IDynamicIntegrationEventHandler
        {
